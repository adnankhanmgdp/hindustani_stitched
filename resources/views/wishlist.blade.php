...
<head>
    ...
    <title>Kalles wishlist page</title>
...
<body
                ...
                <div class="cat_toolbar row fl_center al_center mt__30">
                    <div class="cat_view col-auto">
                        <div class="dn dev_desktop">
                            <a href="/wishlist#" data-mode="grid" data-dev="dk" data-col="6"
                                class="pr mr__10 cat_view_page view_6"></a>
                            <a href="/wishlist#" data-mode="grid" data-dev="dk" data-col="4"
                                class="pr mr__10 cat_view_page view_4"></a>
                            <a href="/wishlist#" data-mode="grid" data-dev="dk" data-col="3"
                                class="pr mr__10 cat_view_page view_3 active"></a>
                            <a href="/wishlist#" data-mode="grid" data-dev="dk" data-col="15"
                                class="pr mr__10 cat_view_page view_15"></a>
                            <a href="/wishlist#" data-mode="grid" data-dev="dk" data-col="2"
                                class="pr cat_view_page view_2"></a>
                        </div>
                        <div class="dn dev_tablet dev_view_cat">
                            <a href="/wishlist#" data-dev="tb" data-col="6"
                                class="pr mr__10 cat_view_page view_6"></a>
                            <a href="/wishlist#" data-dev="tb" data-col="4"
                                class="pr mr__10 cat_view_page view_4"></a>
                            <a href="/wishlist#" data-dev="tb" data-col="3" class="pr cat_view_page view_3"></a>
                        </div>
                        <div class="flex dev_mobile dev_view_cat">
                            <a href="/wishlist#" data-dev="mb" data-col="12"
                                class="pr mr__10 cat_view_page view_12"></a>
                            <a href="/wishlist#" data-dev="mb" data-col="6" class="pr cat_view_page view_6"></a>
                        </div>
                    </div>
                </div>
                <!--end grid control-->
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="kalles-section tp_se_cdt">
                            ...
                            <div class="result_clear mt__30 mb__20 dn">
                                ...
                                <a class="clear_filter dib" href="/wishlist#">Clear All Filter</a><a
                                    href="/wishlist#" class="clear_filter dib bf_icons"
                                    aria-label="Remove tag Size  M">Size M</a><a href="/wishlist#"
                                    class="clear_filter dib bf_icons" aria-label="Remove tag Color  Cyan">Color
                                    Cyan</a><a href="/wishlist#" class="clear_filter dib bf_icons"
                                    ...
                                    <div class="product-inner pr">
                                        <div class="product-image pr oh lazyload">
                                            ...
                                            <div class="nt_add_w ts__03 pa ">
                                                <a href="/wishlist#"
                                                    class="cb chp ttip_nt tooltip_right wis_remove"><span
                                            ...
                                            <div class="hover_button op__0 tc pa flex column ts__03">
                                                <a class="pr nt_add_qv js_add_qv cd br__40 pl__25 pr__25 bgw tc dib ttip_nt tooltip_top_left"
                                                    href="/wishlist#"><span class="tt_txt">Quick view</span><i
                            ...
                            <div class="products-footer tc mt__40">
                                <nav class="nt-pagination w__100 tc paginate_ajax">
                                    <ul class="pagination-page page-numbers">
                                        <li><a class="prev page-numbers" href="/wishlist#">Prev</a></li>
                                        <li><span class="page-numbers">1</span></li>
                                        <li><a class="page-numbers current" href="/wishlist#">2</a></li>
                                        <li><a class="page-numbers" href="/wishlist#">3</a></li>
                                        <li><a class="page-numbers" href="/wishlist#">4</a></li>
                                        <li><a class="next page-numbers" href="/wishlist#">Next</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <!--end navigation-->
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="/wishlist#" data-id="#RegisterForm" class="link_acc">Create your account</a>
                        </p>
                        <p>Lost password?
                            <a href="/wishlist#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="/wishlist#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="/wishlist#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="/wishlist#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="/wishlist#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="/wishlist#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="/wishlist#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- cookies law info -->
    <div id="kalles-section-cookies_law" class="kalles-section pf b__0 r__0 l__0 bgw pp_onshow">
        <div class="popup_cookies_wrap container-fluid pl__0 pr__0" data-stt='{ "day_next": 30,"pp_version":1 }'>
            <div class="row al_center fl_center tc tl_md">
                <div class="col-12 col-md popup_cookies_text">We use cookies to improve your experience on our website.
                    By browsing this website, you agree to our use of cookies.</div>
                <div class="col-12 col-md-auto popup_cookies_btns">
                    <a href="/wishlist#" class="pp_cookies_more_btn tu dib">More info</a>
                    <a href="/wishlist#" class="pp_cookies_accept_btn tu dib">Accept</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="/wishlist#"><span class="tc br__50 db cw"><i
