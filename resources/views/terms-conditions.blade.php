...
<body
                ...
                <div class="terms cb">
                    ...
                    <div class="kalles-term-exp mb__20">
                        ...
                        <p>All features, content, specifications, products and prices of products and services described
                            ...
                            purposes only. &nbsp;We make all reasonable efforts to accurately display the attributes of
                            our products, including the applicable colors; however, the actual color you see will depend
                            on your computer system and we cannot guarantee that your computer will accurately display
                            such colors. &nbsp;The inclusion of any products or services in this website at a particular
                            time does not imply or warrant that these products or services will be available at any
                            time. &nbsp;It is your responsibility to ascertain and obey all applicable local, state and
                            international laws in regard to the possession, use and sale of any item purchased from this
                            website. By placing an order, you represent that the products ordered will be used only in a
                            lawful manner.</p>
                    </div>
                    <div class="kalles-term-exp mb__20">
                        ...
                        <p>When an order is placed, it will be shipped to an address designated by the purchaser as long
                            ...
                            website. &nbsp;All purchases from this website are made pursuant to a shipment contract.
                            &nbsp;As a result, risk of loss and title for items purchased from this website pass to you
                            upon delivery of the items to the carrier. &nbsp;You are responsible for filing any claims
                    ...
                    <div class="kalles-term-exp mb__20">
                        ...
                        <p>You are responsible for maintaining the confidentiality of your account and password
                            ...
                            account and password. &nbsp;This website and The Company Pte Ltd reserves the right to
                            refuse service, terminate accounts remove or edit content or cancel orders.<br>By placing an
                            order, you warrant that you are over 18 years of age, and that you are providing
                            shop.company.com or shop.beetle.com.sg with accurate, truthful information and that you have
                            the authority to place the order.</p>
                    </div>
                    <div class="kalles-term-exp mb__20">
                        ...
                        <p>New, unused full-price merchandise purchased at store retail store may be exchange at any
                            ...
                            may not be exchanged. <br>We offer a no-refund policy on all merchandises, however, for
                            merchandise qualifying for an exchange, item may be exchange for store credits which may be
                            used at our Singapore outlets only. <br>Merchandise on sale may not be exchanged or
                            returned. All merchandise must be returned in sellable condition, otherwise, an exchange
                            would not be allowed.<br>We reserve the right to reject any form of exchange without the
                            original receipt.</p>
                    </div>
                    <div class="kalles-term-exp mb__20">
                        ...
                        <p>Electronic Communications <br>When you visit this website and/or send email to us, you
                            consent to receive electronic communications from us. You agree that all agreements,
                            notices, disclosures and other communications that we sent you electronically satisfy any
                            legal requirement that such communications be in writing</p>
                        <p>Exclusions of Warranties <br>The Company Private Limited makes no representative or warranty
                            regarding the good working order or condition of this website, its suitability for use, or
                            that its use will be uninterrupted or error-free. All information or material provided in
                            this website to you â€œas isâ€ and without warranties of any kind, expressed or implied,
                            including without limitation, warranties or conditions of merchantability, fitness, quality,
                            durability or suitability for any particular purpose, or non-infringement.</p>
                    </div>
                </div>
            </div>
            <!--end page content-->
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="terms-conditions.html#" data-id="#RegisterForm" class="link_acc">Create your
                                account</a>
                        </p>
                        <p>Lost password?
                            <a href="terms-conditions.html#" data-id="#RecoverForm" class="link_acc">Recover
                                password</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="terms-conditions.html#" data-id="#customer_login" class="link_acc">Back to
                                login</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="terms-conditions.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="terms-conditions.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="terms-conditions.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="terms-conditions.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="terms-conditions.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="terms-conditions.html#"><span class="tc br__50 db cw"><i
