...
<body
                ...
                <div id="kalles-section-faqs" class="kalles-section nt_section type_faq js_faq_ad mt__50 mb__50">
                    <div class="kalles-tabs sp-tabs">
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_faqs-0">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_faqs-0"><span class="txt_h_tab">Do I need to open an account
                                        in order to shop with you?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-2">No, you don’t need to. You can make purchases and check out as a guest
                                    everytime.</p>
                                <p class="mb-0">However, by setting up an account with us, it will allow you to order
                                    without having to enter your details every time you shop with us. You can sign up
                                    right now, or you can first start shopping and create your account before you check
                                    out at the shopping cart page.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_faqs-1">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_faqs-1"><span class="txt_h_tab">How do I /create an
                                        account?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">Please click on “Login/Register” followed by ‘Create An Account’ and
                                    fill in your personal particulars.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_faqs-2">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_faqs-2"><span class="txt_h_tab">How do I order?</span><span
                                        class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">Shop for the items you want and add it to your shopping cart. When you
                                    have finished, you can proceed to your shopping cart and check out. Check and ensure
                                    that all information is correct before confirming your purchases and payment.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_faqs-3">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_faqs-3"><span class="txt_h_tab">How do I pay for my
                                        orders?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">We accept payments via Paypal and all major credit and debit cards such
                                    as Mastercard, VISA and American Express.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_1600934637620">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_1600934637620"><span class="txt_h_tab">Can I amend and cancel
                                        my order?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">Unfortunately we are unable to cancel an order once it has been placed.
                                    This will allow us to pack your orders efficiently and to minimize errors. It is
                                    advisable to check your order before placing it.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_1600934655033">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_1600934655033"><span class="txt_h_tab">I have a discount code,
                                        how can I use it?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">Key in the voucher code at the field “Voucher Code” and click “Add” in
                                    your Shopping Cart page before proceeding to check out. Please note that we are
                                    unable to manually apply the voucher code to your order if you have missed keying it
                        ...
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_1600934674204">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_1600934674204"><span class="txt_h_tab">How will I know if my
                                        order is confirmed?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">After you have placed your order, you will receive an acknowledgement
                                    e-mail from us to confirm that your orders have been received. However, do note that
                                    orders will only be shipped when your credit card payment has been approved and
                                    billing and delivery address is verified. Alternatively, you may check the status of
                                    your order in “My Account” if you are a registered user.</p>
                            </div>
                        </div>
                        <div class="panel entry-content sp-tab des_mb_2 des_style_2 dn" id="tab_1600935417107">
                            ...
                            <div class="heading bgbl dn">
                                <a class="tab-heading flex al_center fl_between pr cd chp fwm"
                                    href="faqs-2.html#tab_1600935417107"><span class="txt_h_tab">I have problems adding
                                        items to my shopping cart?</span><span class="nav_link_icon ml__5"></span></a>
                            </div>
                            <div class="sp-tab-content">
                                <p class="mb-0">You will be able to add the items as long as it is available. There
                                    could be an instance where the item is in someone else’s shopping cart hence the
                                    status of the items is reflected as “Temporarily Unavailable”.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="faqs-2.html#" data-id="#RegisterForm" class="link_acc">Create your account</a>
                        </p>
                        <p>Lost password?
                            <a href="faqs-2.html#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="faqs-2.html#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="faqs-2.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="faqs-2.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="faqs-2.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="faqs-2.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="faqs-2.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="faqs-2.html#"><span class="tc br__50 db cw"><i
