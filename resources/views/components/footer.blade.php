                                ...
                                <div class="footer-contact">
                                    <p>
                                        <a class="d-block" href="/">
                                            <img class="w__100 mb__15 lz_op_ef lazyload max-width__200px"  src="/assets/images/svg/oie_png2.png">
                                        </a>
                                    </p>
                                    <p>
                                        <i class="pegk pe-7s-map-marker"> </i><span>184 Main Rd E, St Albans
                                            <br> <span class="pl__30">VIC 3021, Australia</span></span>
                                    </p>
                                    <p><i class="pegk pe-7s-mail"></i>
                                        <span><a
                                                href="https://themes.the4.co/cdn-cgi/l/email-protection#f2919d9c86939186b2919d9f82939c8bdc919d9f"><span
                                                    class="__cf_email__"
                                                    data-cfemail="63000c0d1702001723000c0e13020d1a4d000c0e">[email&#160;protected]</span></a></span>
                                    </p>
    ...
    <div id="kalles-section-footer_bot" class="kalles-section footer__bot">
        <div class="footer__bot_wrap pt__20 pb__20">
            <div class="container pr tc">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © {{ now()->year }}
                        <span class="cp">LivLyff</span> all rights reserved. Powered by <a
                            href="https://mybusinessonweb.com">MyBusinessOnWeb.Com</a>
                    </div>
