...
<head>
    ...
    <title>Kalle's my account</title>
...
<body
                ...
                <div class="row">
                    <div class="col-12 col-md-6 login-form mt__60 mb-0 mb-md-5">
                        <div id="CustomerLoginForm" class="kalles-wrap-form">
                            <h2>Login</h2>
                            <form method="post" action="my-account.html#">
                                <p class="form-row">
                                    <label for="lg-email">Email <span class="required">*</span></label>
                                    <input type="email" name="customer[email]" id="lg-email" autocomplete="email">
                                </p>
                                <p class="form-row">
                                    <label for="lg-pw">Password <span class="required">*</span></label>
                                    <input type="password" value="" name="customer[password]" id="lg-pw">
                                </p>
                                <p><a href="my-account.html#RecoverPasswordForm" class="btn-change-login-form">Forgot
                                        your password?</a>
                                </p>
                        ...
                        <div id="RecoverPasswordForm" class="kalles-wrap-form dn">
                            ...
                            <p>Lost your password? Please enter your email address. You will receive a link to create a
                            ...
                            <form method="post" action="my-account.html#">
                                ...
                                <a href="my-account.html#CustomerLoginForm"
                                    class="button ml__15 btn-change-login-form">Cancel</a>
                            </form>
                        </div>
                    </div>
                        ...
                        <div id="CustomerRegisterForm">
                            ...
                            <form method="post" action="my-account.html#">
                                <p class="form-row">
                                    ...
                                    <input type="text" name="customer[first_name]" id="rgs-f_name"
                                        autocomplete="given-name">
                                </p>
                                <p class="form-row">
                                    <label for="reg-l_name">Last Name</label>
                                    <input type="text" name="customer[last_name]" id="reg-l_name"
                                        autocomplete="family-name">
                                </p>
                                <p class="form-row">
                                    <label for="reg-email">Email <span class="required">*</span></label>
                                    <input type="email" name="customer[email]" id="reg-email" autocomplete="email"
                                        aria-required="true">
                                </p>
                                <p class="form-row">
                                    <label for="reg-pw">Password <span class="required">*</span></label>
                                    <input type="password" name="customer[password]" id="reg-pw" aria-required="true">
                                </p>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="my-account.html#" data-id="#RegisterForm" class="link_acc">Create your account</a>
                        </p>
                        <p>Lost password?
                            <a href="my-account.html#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="my-account.html#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="my-account.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="my-account.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="my-account.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="my-account.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="my-account.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="my-account.html#"><span class="tc br__50 db cw"><i
