...
<body
        ...
        <div class="h__banner bgp pt__10 pb__10 fs__14 flex fl_center al_center pr oh show_icon_false">
            <div class="container">
                <div class="row al_center">
                    <div class="col-auto op__0"><a href="checkout.html#"
                            class="h_banner_close pr pl__10 cw z_index">close</a></div>
                    <a href="shop.html" class="pa t__0 l__0 r__0 b__0 z_100"></a>
                    <div class="col h_banner_wrap tc cw">Today deal sale off
                        <strong>70% </strong>. End in<strong class="js_kl__countdown" data-date="2021/12/19"></strong>.
                        Hurry Up<i class="las la-arrow-right"></i>
                    </div>
                    <div class="col-auto"><a href="checkout.html#" class="h_banner_close pr pl__10 cw z_100">close</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="order-review__wrapper">
                                ...
                                <div class="checkout-order-review">
                                    <table class="checkout-review-order-table">
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">Black mountain hat<strong
                                                        class="product-quantity">× 1</strong>
                                                </td>
                                                <td class="product-total"><span class="cart_price">$50.00</span></td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">Cream women pants<strong
                                                        class="product-quantity">× 1</strong>
                                                </td>
                                    ...
                                    <div class="checkout-payment">
                                        <ul class="payment_methods">
                                            ...
                                            <li class="payment_method">
                                                ...
                                                <label for="payment_method_stripe">
                                                    ...
                                                    <img src="assets/images/shopping-cart/mastercard.svg"
                                                        class="stripe-mastercard-icon stripe-icon" alt="Mastercard">
                                                    <img src="assets/images/shopping-cart/amex.svg"
                                                        class="stripe-amex-icon stripe-icon" alt="American Express">
                                                    <img src="assets/images/shopping-cart/discover.svg"
                                                        class="stripe-discover-icon stripe-icon" alt="Discover">
                                                    <img src="assets/images/shopping-cart/diners.svg"
                                                        class="stripe-diners-icon stripe-icon" alt="Diners">
                                                    <img src="assets/images/shopping-cart/jcb.svg"
                                                        class="stripe-jcb-icon stripe-icon" alt="JCB">
                                                </label>
                                                <div class="payment_box payment_method_bacs dn">
                                                    <p>Pay with your credit card via Stripe. TEST MODE ENABLED. In test
                                                        mode, you can use the card number 4242424242424242 with any CVC
                                                        and a valid expiration date or check the Testing Stripe
                                                        documentation for more card numbers.</p>
                                                    <div class="credit-card-form">
                                                        ...
                                                        <div class="form-row form-row-last">
                                                            ...
                                                            <div class="stripe-card-group">
                                                                <input type="text" name="card-number"
                                                                    id="stripe-cvc-element" value="" placeholder="CVC">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <p class="checkout-payment__policy-text">Your personal data will be used to
                                            process your order, support your experience throughout this website, and for
                                            other purposes described in our<a href="checkout.html#">privacy policy</a>.
                                        </p>
                                        <label class="checkout-payment__confirm-terms-and-conditions">
                                            <input type="checkbox" name="terms" id="terms">
                                            <span>I have read and agree to the website <a href="checkout.html#"
                                                    class="terms-and-conditions-link">terms and
                                                    conditions</a></span>&nbsp;<span class="required">*</span>
                                        </label>
                                        <button type="button"
                                            class="button button_primary btn checkout-payment__btn-place-order">Place
                                            order</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="search_header__content mini_cart_content fixcl-scroll widget">
                    <div class="fixcl-scroll-content product_list_widget">
                        <div class="js_prs_search">
                            ...
                            <a href="checkout.html#" class="btn fwsb detail_link">View All
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="checkout.html#" data-id="#RegisterForm" class="link_acc">Create your account</a>
                        </p>
                        <p>Lost password?
                            <a href="checkout.html#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="checkout.html#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="checkout.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="checkout.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="checkout.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="checkout.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="checkout.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
                    ...
                    <div class="product-inner pr">
                        <div class="product-image pr oh lazyload">
                            ...
                            <div class="nt_add_w ts__03 pa ">
                                <a href="checkout.html#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                            ...
                            <div class="hover_button op__0 tc pa flex column ts__03">
                                <a class="pr nt_add_qv js_add_qv cd br__40 pl__25 pr__25 bgw tc dib ttip_nt tooltip_top_left"
                                    href="checkout.html#"><span class="tt_txt">Quick view</span><i
                ...
                <div class="col-lg-3 col-md-4 col-12 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                    <div class="product-inner pr">
                        <div class="product-image pr oh lazyload">
                            ...
                            <div class="nt_add_w ts__03 pa ">
                                <a href="checkout.html#" class="wishlistadd cb chp ttip_nt tooltip_right">
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="checkout.html#"><span class="tc br__50 db cw"><i
