...
<body
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="store-local mt__20">
                                ...
                                <p class="mb-1">UG Floor Unit-123A, Jl. Let Jend S.Parman Kav.28, Jakarta Barat 11470
                                </p>
                                <p class="mb-0">Tel: +62-21 29200095</p>
                            </div>
                            <div class="store-local mt__20">
                                <h4 class="mt-0 mb-2">Pondok Indah Mall 2</h4>
                                <p class="mb-1">1st Floor #127, Jl. Metro Pondok Indah Blok 3B, Jakarta Selatan 12310
                                </p>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="store-local mt__20">
                                ...
                                <p class="mb-1">1st Floor, Unit 125-126, Jl. Dharma Husada Indah Timur No.37, Surabaya
                                    60115</p>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="store-location.html#" data-id="#RegisterForm" class="link_acc">Create your
                                account</a>
                        </p>
                        <p>Lost password?
                            <a href="store-location.html#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="store-location.html#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="store-location.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="store-location.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="store-location.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="store-location.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="store-location.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="store-location.html#"><span class="tc br__50 db cw"><i
