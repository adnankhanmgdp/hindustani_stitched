...
<head>
    ...
    <title>Kalle's shop collection</title>
...
<body
    ...
    <div id="nt_wrapper">
        ...
        <div id="nt_content">
            ...
            <!--category heading-->
            <div id="kalles-section-list_cat_heading" class="kalles-section page_section_heading">
                <div class="page-head tc pr oh cat_bg_img page_head_shop ">
                    ...
                    <div class="container pr z_100">
                        <h1 class="mb__5 cw">Collections</h1>
                    </div>
                </div>
            </div>
            ...
            <!--list collection-->
            <div id="kalles-section-list-collections-template" class="kalles-section">
                <div class="container container_cat cat_default mt__60 mb__60">
                    <div class="nt_cats_holder row fl_center equal_nt hoverz_true ratio_nt cat_space_30 cat_design_1">
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-01.jpg"></div>
                                    </a>
                                </div>
                        ...
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-02.jpg"></div>
                                    </a>
                                </div>
                                <div class="cat_grid_item__wrapper pe_none">
                        ...
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-03.jpeg"></div>
                                    </a>
                                </div>
                                <div class="cat_grid_item__wrapper pe_none">
                        ...
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-04.jpeg"></div>
                                    </a>
                                </div>
                                <div class="cat_grid_item__wrapper pe_none">
                        ...
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-05.jpg"></div>
                                    </a>
                                </div>
                                <div class="cat_grid_item__wrapper pe_none">
                        ...
                        <div class="cat_grid_item cat_space_item col-lg-4 col-md-3 col-6">
                            <div class="pr oh">
                                <div class="cat_grid_item__content pr oh">
                                    <a href="shop-left-sidebar.html" class="db cat_grid_item__link">
                                        <div class="cat_grid_item__overlay nt_bg_lz lazyload"
                                            data-bgset="assets/images/shop/collection-list/cat-06.jpeg"></div>
                                    </a>
                                </div>
                                <div class="cat_grid_item__wrapper pe_none">
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">New customer?
                            <a href="shop-collection.html#" data-id="#RegisterForm" class="link_acc">Create your
                                account</a>
                        </p>
                        <p>Lost password?
                            <a href="shop-collection.html#" data-id="#RecoverForm" class="link_acc">Recover password</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Remembered your password?
                            <a href="shop-collection.html#" data-id="#customer_login" class="link_acc">Back to login</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        ...
                        <p class="mb__10 mt__20">Already have an account?
                            <a href="shop-collection.html#" data-id="#customer_login" class="link_acc">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div id="kalles-section-toolbar_mobile" class="kalles-section">
        <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
            ...
            <div class="type_toolbar_filter kalles_toolbar_item dn">
                <a class="dt_trigger_cl" href="shop-collection.html#" data-trigger=".btn_filter">
                    <span class="toolbar_icon"></span>
            ...
            <div class="type_toolbar_cart kalles_toolbar_item">
                <a href="shop-collection.html#" class="push_side" data-id="#nt_cart_canvas">
                    <span class="toolbar_icon">
            ...
            <div class="type_toolbar_account kalles_toolbar_item">
                <a href="shop-collection.html#" class="push_side" data-id="#nt_login_canvas">
                    <span class="toolbar_icon"></span>
                    <span class="kalles_toolbar_label">Account</span>
                </a>
            </div>
            <div class="type_toolbar_search kalles_toolbar_item">
                <a href="shop-collection.html#" class="push_side" data-id="#nt_search_canvas">
                    <span class="toolbar_icon"></span>
    ...
    <!-- back to top button-->
    <a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="shop-collection.html#"><span class="tc br__50 db cw"><i
